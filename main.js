...
console.log('Only first: ', funcs.onlyFirst(arr)[0])
console.log('All but last: ', funcs.allButLast(arr))
console.log('Only last: ', funcs.onlyLast(arr)[0])
console.log('All but first: ', funcs.allButFirst(arr))
console.log('Return index 2: ', funcs.returnN(arr, 2)[0])
console.log('Return index -2 (last index instead): ', funcs.returnN(arr, -2)[0])
